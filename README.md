...
- [1. Primeiro contato com Inteligência Artificial](#1-primeiro-contato-com-inteligência-artificial)
  - [Três experiências de 15 minutos](#três-experiências-de-15-minutos)
- [2. Conceitos principais sem complicação](#2-conceitos-principais-sem-complicação)
  - [Um modelo simples de bom prompt](#um-modelo-simples-de-bom-prompt)
  - [Há muitas ferramentas, mas a lógica está convergindo](#há-muitas-ferramentas-mas-a-lógica-está-convergindo)
- [3. Agents e arquitetura multi-agent](#3-agents-e-arquitetura-multi-agent)
  - [Modelo mental: coordinator e workers](#modelo-mental-coordinator-e-workers)
- [4. Grok Bot: primeira experiência com vários Agents](#4-grok-bot-primeira-experiência-com-vários-agents)
  - [Três Bots para criar](#três-bots-para-criar)
  - [Exercício em chat de grupo](#exercício-em-chat-de-grupo)
- [5. Google Colab e Python básico](#5-google-colab-e-python-básico)
  - [Como usar o Colab](#como-usar-o-colab)
  - [O mínimo de Python para começar](#o-mínimo-de-python-para-começar)
  - [Exercícios clássicos com funções](#exercícios-clássicos-com-funções)
  - [Projeto rápido com dados de Pokémon](#projeto-rápido-com-dados-de-pokémon)
...
- [7. Estrutura de projeto simples e agent-friendly](#7-estrutura-de-projeto-simples-e-agent-friendly)
  ...
  - [Setup rápido para projetos descartáveis](#setup-rápido-para-projetos-descartáveis)
- [8. VS Code com Agents](#8-vs-code-com-agents)
  - [É preciso instalar Python antes?](#é-preciso-instalar-python-antes)
- [9. Claude Code sem mistério](#9-claude-code-sem-mistério)
  - [Tudo começa com arquivos Markdown](#tudo-começa-com-arquivos-markdown)
  - [Exemplo de CLAUDE.md simples](#exemplo-de-claudemd-simples)
  - [Agents internos principais](#agents-internos-principais)
  - [Tools principais](#tools-principais)
  - [Rules, skills e Agents: qual usar?](#rules-skills-e-agents-qual-usar)
  - [Cinco comandos úteis](#cinco-comandos-úteis)
- [10. Cursor para planejar e construir](#10-cursor-para-planejar-e-construir)
  - [Use Plan Mode antes de uma feature maior](#use-plan-mode-antes-de-uma-feature-maior)
  - [Dica: crie um `progress.md` para planos com várias fases](#dica-crie-um-progressmd-para-planos-com-várias-fases)
  - [Comandos principais do Cursor CLI](#comandos-principais-do-cursor-cli)
...
- [14. Bônus: Git e GitHub](#14-bônus-git-e-github)
  - [Comandos fundamentais](#comandos-fundamentais)
  - [Três ambientes comuns](#três-ambientes-comuns)
